    ...
    <Wrapper>
      <Inner>
        <ImageCtn>
          ...
          <ButtonContainer>
            <CheckInBtn type="button" onClick={() => window.open('#', '_blank')} >
              <span>Register</span>
              <Image
                src={ic_chevron_down}
                alt="ic_chevron_down"
            ...
            <CheckOutBtn type="button" onClick={() => window.open('#', '_blank')}>
              <span>Login</span>
              <Image
                src={ic_chevron_down}
                alt="ic_chevron_down"
            ...
            <BookRoom type="button" onClick={() => window.open('#', '_blank')}>
        ...
        <BottomTextCtn>
          <Contact>
            ...
            <Reveal textDelay={0.5} slideDelay={0.5}>
              <h3 onClick={() => window.open('https://maps.app.goo.gl/JAxVyGD8L9HrpsZy9', '_blank')}>Pre-Incubation at VIT Vellore</h3>
            </Reveal>
          </Contact>
          <Suite>
            <Reveal textDelay={1} slideDelay={1}>
              <h3>Growing Future</h3>
              <span>Together</span>
            </Reveal>
          </Suite>
        </BottomTextCtn>
